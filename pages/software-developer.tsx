    ...
    <div>
      ...
      <div className="flex justify-center m-5">
        <div className="absolute flex justify-center items-center h-full">
          <div className="text-5xl text-red-500 uppercase border-8 border-red-500 p-8 font-bold origin-bottom -rotate-12">
            Closed
          </div>
        </div>
        <div className="">
            ...
            <div>
              ...
              <div>
                <ul className="list-disc ml-4">
                  ...
                  <li>
                    A Human Resources/Performance Management work background
